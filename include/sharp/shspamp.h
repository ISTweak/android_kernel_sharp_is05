...
#define SPAMP_POWER_ON					_IO  ( SHSPAMP_IOC_MAGIC,  1)
#define SPAMP_POWER_OFF					_IO  ( SHSPAMP_IOC_MAGIC,  2)
#define SPAMP_GET_PRGAIN				_IO  ( SHSPAMP_IOC_MAGIC,  3)
#define SPAMP_SET_PRGAIN				_IO  ( SHSPAMP_IOC_MAGIC,  4)

#define SPAMP_SET_MUTEN					_IO  ( SHSPAMP_IOC_MAGIC,  5)
