...
#define __SH_ANDROID_USB_PRODUCTS_H
	...
	#include "sh_android_usb_products_dsn9.h"
#elif defined( CONFIG_MACH_BEC )
	#include "sh_android_usb_products_bec.h"
#elif defined( CONFIG_MACH_JIR )
	#include "sh_android_usb_products_jir.h"
#elif defined( CONFIG_MACH_DECKARD_AS32 )
	#include "sh_android_usb_products_deckard_as32.h"
