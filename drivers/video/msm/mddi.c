...
struct pm_qos_request_list *mddi_pm_qos_req;
...
#ifdef CONFIG_SHLCDC_BOARD
    pm_qos_update_request(mddi_pm_qos_req, PM_QOS_DEFAULT_VALUE);
#endif
...
#ifdef CONFIG_SHLCDC_BOARD
	pm_qos_update_request(mddi_pm_qos_req, 117000);
#endif
...
#ifdef CONFIG_SHLCDC_BOARD
	mddi_pm_qos_req = pm_qos_add_request(PM_QOS_SYSTEM_BUS_FREQ, 117000);
#endif
...
#ifdef CONFIG_SHLCDC_BOARD
        pm_qos_remove_request(mddi_pm_qos_req);
#endif
