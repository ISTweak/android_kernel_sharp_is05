...
unsigned int ext_csd_en_rel_wr_val;
unsigned int ext_csd_rel_wr_sec_c_val;
unsigned int ext_csd_hpi_support_val;
#endif
...
static int mmc_read_ext_csd(struct mmc_card *card)
{
	...
	ext_csd_en_rel_wr_val = ((ext_csd[EXT_CSD_WR_REL_PARAM])>>2)&1;
	/* Reliable write sector count */
	ext_csd_rel_wr_sec_c_val = ext_csd[EXT_CSD_REL_WR_SEC_C];
	/* High Priority Interrupt Support */
	ext_csd_hpi_support_val = (ext_csd[EXT_CSD_HPI_FEATURES])&1;
#endif
