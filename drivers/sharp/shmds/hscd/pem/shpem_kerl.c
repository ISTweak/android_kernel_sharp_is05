...
/* about GPIOs */
#define SHPEM_GPIO_NUM_FW_CTL	98
...
#define SHPEM_GPIO_CNF_FW_CTL	GPIO_CFG(SHPEM_GPIO_NUM_FW_CTL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE
#define SHPEM_GPIO_CNF_COMREQ	GPIO_CFG(SHPEM_GPIO_NUM_COMREQ, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE
...
static shpem_result_t shpem_com_open(shpem_com_param_t* param)
{
...
#ifdef SHPEM_I2C_MUTEX_ENABLE
	sh_qupi2c_mutex_lock(shpem_i2c_client);
#endif	/* SHPEM_I2C_MUTEX_ENABLE */
	...
	{
#ifdef SHPEM_I2C_MUTEX_ENABLE
		sh_qupi2c_mutex_free(shpem_i2c_client);
#endif	/* SHPEM_I2C_MUTEX_ENABLE */
		SHPEM_DEBUG_LOG_1("request_irq Error");
		return SHPEM_COM_ERROR;
	}
