...
#define YAS_ACC_DRIVER_SHARP 	            (15)

/*----------------------------------------------------------------------------*/
/*                               Configuration                                */
/*----------------------------------------------------------------------------*/

#define YAS_ACC_DRIVER                      (YAS_ACC_DRIVER_SHARP)
...
#define YAS_DEFAULT_ACCCALIB_DISTORTION     (1000)
#elif YAS_ACC_DRIVER == YAS_ACC_DRIVER_SHARP
#define YAS_DEFAULT_ACCCALIB_DISTORTION     (4000)
#else
...
#define YAS_ACC_I2C_SLAVEADDR               (0x1c)
#elif YAS_ACC_DRIVER == YAS_ACC_DRIVER_SHARP
#define YAS_ACC_I2C_SLAVEADDR               (NULL)
#else
#error "unknown accelerometer"
#endif
...
#elif YAS_ACC_DRIVER == YAS_ACC_DRIVER_SHARP
#define YAS_ACC_DEFAULT_FILTER_THRESH       (NULL)
#else
#error "unknown accelerometer"
#endif
