...
#define SH_SUBCAM_IOCTL_EVENT_REQUEST_ISR   _IOW(SH_SUBCAM_IOCTL_MAGIC,  12, struct sh_subcam_event_ctrl_cmd *)
#define SH_SUBCAM_IOCTL_FRAMEEVENT_REQUEST_ISR  _IOW(SH_SUBCAM_IOCTL_MAGIC,  13, struct sh_subcam_event_ctrl_cmd *)

#define CAM_INT_TYPE_VS                     1
#define SHSCAM_INT_TYPE_MIPI_ERR            2
#define SHSCAM_INT_TYPE_TIMEOUT             3

#define SHCAM_INT_TYPE_EVENT_ISR            4
#define SHCAM_INT_TYPE_FRAMEEVENT_ISR       5

#define D_SH_SUBCAM_IOCTL_DSP_RW_MAX_SIZE   40

struct sh_subcam_event_ctrl_cmd {
    unsigned int    Id;
    unsigned int    Param1;
    unsigned int    Param2;
    unsigned int    Param3;
...
struct sh_subcam_ctrl_cmd {
    ...
    struct sh_subcam_event_ctrl_cmd     event_data;
};
