...
static struct wake_lock stheno_wake_lock;
...
static int __init stheno_module_init( void )
{
    ...
    wake_lock_init(&stheno_wake_lock, WAKE_LOCK_SUSPEND, "stheno_wake_lock");
...
static void __exit stheno_module_exit( void )
{
    ...
    wake_lock_destroy(&stheno_wake_lock);
