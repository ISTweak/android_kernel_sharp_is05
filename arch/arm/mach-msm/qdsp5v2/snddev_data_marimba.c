...
#ifdef CONFIG_SH_AUDIO_DRIVER
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 101)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 102)
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2200,-1700,-1200,-700,-200,300},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2200,-1700,-1200,-700,-200,300},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 201)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 202)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 204)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 206)
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2200,-1700,-1200,-700,-200,300},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2200,-1700,-1200,-700,-200,300},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 205)
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 301)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 302)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 303)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 304)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 305)
...
static struct snddev_icodec_data snddev_ihs_stereo_rx_data = {
	...
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 201)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 202)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 204)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 205)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 206)
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2500,-2000,-1500,-1000,-500,0},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 301)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 302)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 303)||(CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 305)
	.voice_rx_vol_step[VOC_NB_INDEX] = {-2000,-1600,-1200,-800,-400,0},
	.voice_rx_vol_step[VOC_WB_INDEX] = {-2000,-1600,-1200,-800,-400,0},
#elif (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 304)
...
#ifdef CONFIG_SH_AUDIO_DRIVER
/* [FM transmitter path] [start] */
static struct adie_codec_action_unit fmtrans_rx_48KHz_osr256_actions[] =
	FMTRANS_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry fmtrans_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = fmtrans_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(fmtrans_rx_48KHz_osr256_actions),
 	}
};

static struct adie_codec_dev_profile fmtrans_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = fmtrans_rx_settings,
	.setting_sz = ARRAY_SIZE(fmtrans_rx_settings),
};

static struct snddev_icodec_data snddev_fmtrans_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "fmtrans_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_FM_TRANSMITTER,
	.profile = &fmtrans_rx_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_fmtrans_rx_device = {
	.name = "snddev_icodec",
	.id = 42,
	.dev = { .platform_data = &snddev_fmtrans_rx_data },
};
/* [FM transmitter path] [end] */
#endif /* CONFIG_SH_AUDIO_DRIVER */
