...
static int shext_hs_wake_lock_count = -1;
#endif	/* Wake_Lock <- */
...
#ifdef SHEXTDET_HEADSET_WAKELOCK	/* Wake_Lock -> */
static int hs_wake_unlock(struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
{
