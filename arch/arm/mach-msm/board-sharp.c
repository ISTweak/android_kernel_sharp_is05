...
#if defined(CONFIG_SH_HSCD) || defined(CONFIG_SH_YAS530)
...
#include <linux/usb/android_composite.h>
  ...
  #include <sharp/sh_android_usb_products.h>
#endif /* CONFIG_USB_ANDROID_SH_CUST */
#endif
#ifdef CONFIG_SH_USB_CUST
#include <linux/usb/mass_storage_function.h>
#include <sharp/msm_hsusb_desc.h>
#include <sharp/msm_hsusb_map.h>
...
#ifdef CONFIG_SENSORS_PROXIMITY
#include <sharp/proximity.h>
#endif	/* CONFIG_SENSORS_PROXIMITY */

#ifdef CONFIG_SHPMIC_UPL
#include <linux/pmic8058-upl.h>
#endif /* CONFIG_SHPMIC_UPL */

#if defined( CONFIG_I2C_CUST_SH_SMEM )
#define SMEM_SPINLOCK_I2C	"S:6"
#endif /* CONFIG_I2C_CUST_SH_SMEM */

#ifdef CONFIG_SHHDMI_DRIVER
#define SHHDMI_FB_SIZE		(720 * 1280 * 4 * 2)
#else
#define SHHDMI_FB_SIZE		0
#endif /* CONFIG_SHHDMI_DRIVER */

#define MSM_PMEM_SF_SIZE	0x1C91000
#ifdef CONFIG_SHLCDC_BOARD
#ifdef CONFIG_MACH_DECKARD_AS32
#define MSM_FB_SIZE		((480 * 854 * 4 * 2) + SHHDMI_FB_SIZE + 0x600) /* 0x600 is Padding. */
#else
#define MSM_FB_SIZE		0x9F6000
#endif /*CONFIG_MACH_DECKARD_AS32*/
#endif /*CONFIG_SHLCDC_BOARD*/
#ifndef CONFIG_SH_CAMERA
#if defined(CONFIG_MACH_DECKARD_AS36) || defined(CONFIG_MACH_KOH)
#define MSM_PMEM_ADSP_SIZE      0x3500000
#else
#define MSM_PMEM_ADSP_SIZE      0x1800000
#endif /* CONFIG_MACH_DECKARD_AS36 || CONFIG_MACH_KOH */
#else
#if defined( CONFIG_MACH_DECKARD_AF20 ) || defined( CONFIG_MACH_DECKARD_AS35 )
#define MSM_PMEM_ADSP_SIZE      0x3500000
#else
#ifdef CONFIG_MACH_RYK
#define MSM_PMEM_ADSP_SIZE      0x4E00000
#else
#define MSM_PMEM_ADSP_SIZE      0x3C80000
#endif
#endif /* CONFIG_MACH_DECKARD_AF20 || CONFIG_MACH_DECKARD_AS35 */
#endif /* CONFIG_SH_CAMERA */
#define MSM_FLUID_PMEM_ADSP_SIZE	0x2800000
#if defined( CONFIG_SHSYS_CUST )
#define PMEM_KERNEL_EBI1_SIZE   0xb80000
#else
...
#ifdef CONFIG_SHPMIC_UPL
static int sh_pm8058_upl_init( void )
{
	struct pm8058_upl_device *upl_dev;
	int rc = 0;
    
	upl_dev = pm8058_upl_request();

	rc = pm8058_upl_write_truthtable(upl_dev, 0x000a);

    if(rc){
		printk(KERN_ERR "%s: write truthtable FAIL: 0x%x \n", __func__ , rc );
		return rc;
    }
    rc = pm8058_upl_config( upl_dev, 
                            PM8058_UPL_MOD_ENABLE_MASK | PM8058_UPL_OUT_DTEST_MASK | PM8058_UPL_IN_A_MASK | PM8058_UPL_IN_B_MASK | PM8058_UPL_IN_C_MASK | PM8058_UPL_IN_D_MASK, 
                            PM8058_UPL_MOD_ENABLE | PM8058_UPL_OUT_GPIO_ONLY | PM8058_UPL_IN_A_GPIO | PM8058_UPL_IN_B_GPIO | PM8058_UPL_IN_C_GPIO | PM8058_UPL_IN_D_GPIO );
    if(rc){
		printk(KERN_ERR "%s: upl_config FAIL: 0x%x \n", __func__ , rc );
		return rc;
    }
	return 0;
}
...
/* SBM KEY Drv key map change end */
...
static struct pmic8058_keypad_data surf_keypad_data = {
	...
	.debounce_ms		= {SH_DEBOUNCE_MS0, SH_DEBOUNCE_MS1},
...
#ifdef CONFIG_SHPMIC_UPL
static struct pm8058_gpio_platform_data sh_pm8058_upl_data = {
	.init		= sh_pm8058_upl_init,
};
#endif /* CONFIG_SHPMIC_UPL */
...
static struct mfd_cell pm8058_subdevs[] = {
	...
	{	.name = "pm8058-upl",
		.id		= -1,
#ifdef CONFIG_SHPMIC_UPL
		.platform_data	= &sh_pm8058_upl_data,
		.data_size	= sizeof(sh_pm8058_upl_data),
#endif /* CONFIG_SHPMIC_UPL */
	},
};
...
#ifdef CONFIG_LEDS_KEY_LED
static struct platform_device shkeyled_device = {
	.name   = "shkeyled",
	.id = -1,
};
#endif	/* CONFIG_LEDS_KEY_LED */

#ifdef CONFIG_LEDS_KEYBOARD_LED
static struct platform_device shkeyboardled_device = {
	.name   = "shkeyboardled",
	.id = -1,
};
#endif	/* CONFIG_LEDS_KEYBOARD_LED */
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_SH_HSCD)
#else
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_SH_CAMERA) || defined(CONFIG_I2C_CUST_SH) || defined(CONFIG_SH_HSCD)
#else
GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* VCM */
#endif	/* CONFIG_SENSORS_AMI602 || CONFIG_MPU_SENSORS_MPU3050 || CONFIG_SH_CAMERA || CONFIG_I2C_CUST_SH || CONFIG_SH_HSCD */
};

static uint32_t camera_off_gpio_table[] = {
	/* parallel CAMERA interfaces */
#if defined( CONFIG_I2C_CUST_SH ) || defined( CONFIG_SH_CAMERA )
#else
	GPIO_CFG(0,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* RST */
#endif	/* CONFIG_I2C_CUST_SH */
#ifndef CONFIG_SH_CAMERA
	#if !defined(CONFIG_T8EV4)	/* 8MCMOS_SENSOR = MIPI-CSI */
...
static uint32_t camera_on_gpio_table[] = {
	...
	#else
	GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,  GPIO_CFG_10MA),/* MCLK */
	#endif	/* CONFIG_T8EV4 */
#endif	/* CONFIG_SH_CAMERA */
};

static uint32_t camera_off_gpio_fluid_table[] = {
#if !defined(CONFIG_SH_CAMERA) && !defined(CONFIG_T8EV4)
	/* FLUID: CAM_VGA_RST_N */
...
#endif	/* CONFIG_SH_CAMERA *//* CONFIG_T8EV4 */
};
...
#endif
#ifdef CONFIG_T8EV4
static struct msm_camera_sensor_flash_data flash_t8ev4 = {
	.flash_type = MSM_CAMERA_FLASH_LED,
	.flash_src  = &msm_flash_src_pwm
};
static struct msm_camera_sensor_info msm_camera_sensor_t8ev4_data = {
	.sensor_name    = "t8ev4",
	.sensor_reset   = 22/*0*/,
	.sensor_pwd     = 0/*85*/,
	.vcm_pwd        = 0/*1*/,
	...
	.resource       = msm_camera_resources,
	.num_resources  = ARRAY_SIZE(msm_camera_resources),
	.flash_data     = &flash_t8ev4,
	.csi_if         = 1
};
static struct platform_device msm_camera_sensor_t8ev4 = {
	.name  	= "msm_camera_t8ev4",
	.dev   	= {
		.platform_data = &msm_camera_sensor_t8ev4_data,
	},
};
#endif
#ifdef CONFIG_VX6953
...
#endif /* #if !defined( CONFIG_SH_AUDIO_DRIVER ) */
...
static struct msm_gpio mi2s_clk_gpios[] = {
	...
	{ GPIO_CFG(144, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	    "MI2S_WS"},
#else
	{ GPIO_CFG(145, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA),
	    "MI2S_SCLK"},
	{ GPIO_CFG(144, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA),
	    "MI2S_WS"},
#endif /* #if !defined( CONFIG_SH_AUDIO_DRIVER ) */
...
#ifdef CONFIG_USB_ANDROID
#ifdef CONFIG_USB_ANDROID_SH_CUST
/* refer to <sharp/sh_android_usb_products.h> */
...
#ifdef CONFIG_USB_ANDROID_SH_CUST
	.vendor_id	= 0x04DD,
	.product_id	= ANDROID_USB_SH_DEFAULT_PID,
	.version	= 0x0100,
	.product_name		= ANDROID_USB_SH_PRODUCT_NAME,
	.manufacturer_name	= ANDROID_USB_SH_MANUFACTER_NAME,
#else /* CONFIG_USB_ANDROID_SH_CUST */
	.vendor_id	= 0x05C6,
	.product_id	= 0x9026,
	.version	= 0x0100,
...
/* COORDINATOR Qualcomm404005 MERGE start */
static bool hdmi_check_hdcp_hw_support(void);
/* COORDINATOR Qualcomm404005 MERGE end */
#endif  /*CONFIG_SHLCDC_BOARD*/
...
static const struct
{
	...
	{
		{	SH_PROXIMITY_IRQ, GPIO_CFG(SH_PROXIMITY_IRQ,   0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),  "gpio_proximity_irq"	},
	};
...
static int proximity_gpio_setup(void)
{
	...
	for(i = 0; i < ARRAY_SIZE(msm_i2c_proximity); i++)
	{
		rc = gpio_tlmm_config(msm_i2c_proximity[i].cfg, GPIO_CFG_ENABLE);
		if (rc) {
...
#if defined( CONFIG_SH_AUDIO_DRIVER )
#if defined( CONFIG_SHSPAMP_AK7833 )
	{
		I2C_BOARD_INFO("sh_spamp_i2c", 0x24 >> 1),
	},
#elif defined( CONFIG_SHSPAMP_AN12969 )
	{
		I2C_BOARD_INFO("sh_spamp_i2c", 0xB6 >> 1),
	},
#endif /* #if defined( CONFIG_SHSPAMP_AK7833 ) */
#endif /* #if defined( CONFIG_SH_AUDIO_DRIVER ) */
#ifdef CONFIG_SHFELICA
	{
...
#endif /* CONFIG_MPU_SENSORS_MPU3050 */
#ifdef CONFIG_SENSORS_AMI602
static struct i2c_board_info msm_gsb_board_info[] = {
	{
		I2C_BOARD_INFO(SH_MS_I2C_DEVNAME, SH_MS_I2C_SLAVE >> 1),
		.irq           = MSM_GPIO_TO_INT(SH_MS_IRQ)
	},
};
#endif /* CONFIG_SENSORS_AMI602 */
#ifdef CONFIG_SH_HSCD
static const struct
{
	int pinno;
	unsigned cfg;
	...
	{
		{	SH_COMPS_IRQ,  GPIO_CFG(SH_COMPS_IRQ,   0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),  "gpio_comps_irq"	},
		{	SH_COMPS_DRDY, GPIO_CFG(SH_COMPS_DRDY,  0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),  "gpio_comps_drdy"	},
	};
...
static int comps_gpio_setup(void)
{
	...
	for(i = 0; i < ARRAY_SIZE(msm_i2c_comps); i++)
	{
		rc = gpio_tlmm_config(msm_i2c_comps[i].cfg, GPIO_CFG_ENABLE);
		if (rc) {
...
static struct sh_i2c_compass_platform_data platform_compass_data = {
	.gpio_IRQ = SH_COMPS_IRQ,
	.gpio_DRDY = SH_COMPS_DRDY,
...
static struct i2c_board_info msm_gsb_board_info[] = {
	{
		...
		.irq           =  MSM_GPIO_TO_INT(SH_COMPS_DRDY),
		.platform_data  = &platform_compass_data
	},
	{
...
#endif	/* CONFIG_SH_HSCD */

#ifdef CONFIG_USB_FUNCTION
#ifdef CONFIG_SH_USB_CUST
/* refer usb_functions_map[] and usb_func_composition[] to msm_hsusb_map.h  */
...
static ssize_t shtps_gb_vkeys_show(struct kobject *kobj,
			struct kobj_attribute *attr, char *buf)
{
    return sprintf(buf, __stringify(EV_KEY) ":" __stringify(KEY_MENU)   ":61:955:80:80"
                    ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":182:955:80:80"
                    ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":302:955:80:80"
                    ":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":421:955:80:80"
                    "\n");
}

static struct kobj_attribute shtps_gb_vkeys_attr = {
	.attr = {
		.mode = S_IRUGO,
	},
	.show = &shtps_gb_vkeys_show,
};

static struct attribute *shtps_gb_properties_attrs[] = {
	&shtps_gb_vkeys_attr.attr,
	NULL
};

static struct attribute_group shtps_gb_properties_attr_group = {
	.attrs = shtps_gb_properties_attrs,
};

static struct kobject *shtps_gb_vkeys_properties_kobj;
#endif /* #if defined( CONFIG_MACH_RYK ) */
...
#if defined( CONFIG_MACH_NSK )
	/* virtual keys */
	shtps_ryk_vkeys_attr.attr.name = "virtualkeys.shtps_rmi";
	shtps_ryk_vkeys_properties_kobj = kobject_create_and_add("board_properties", NULL);
	if (!shtps_ryk_vkeys_properties_kobj) {
		pr_err("%s: failed to create a kobject"
				"for board_properites\n", __func__);
		rc = -ENOMEM;
		goto vreg_get_fail;
	}
	rc = sysfs_create_group(shtps_ryk_vkeys_properties_kobj,
			&shtps_ryk_properties_attr_group);
	if (rc) {
		pr_err("%s: failed to create a sysfs entry %s\n",
				__func__, shtps_ryk_vkeys_attr.attr.name);
		kobject_put(shtps_ryk_vkeys_properties_kobj);
		goto vreg_get_fail;
	}
...
#elif defined( CONFIG_MACH_DECKARD_AS32 )
	/* virtual keys */
	shtps_gb_vkeys_attr.attr.name = "virtualkeys.shtps_rmi";
	shtps_gb_vkeys_properties_kobj = kobject_create_and_add("board_properties", NULL);
	if (!shtps_gb_vkeys_properties_kobj) {
		pr_err("%s: failed to create a kobject"
				"for board_properites\n", __func__);
		rc = -ENOMEM;
		goto vreg_get_fail;
	}
	rc = sysfs_create_group(shtps_gb_vkeys_properties_kobj,
			&shtps_gb_properties_attr_group);
	if (rc) {
		pr_err("%s: failed to create a sysfs entry %s\n",
				__func__, shtps_gb_vkeys_attr.attr.name);
		kobject_put(shtps_gb_vkeys_properties_kobj);
		goto vreg_get_fail;
	}
...
#endif
#if defined(CONFIG_SHLCDC_SUBDISPLAY)
static int msm_shlcdc_gpio_setup(struct device *dev)
{
  return 0;
}

static void msm_shlcdc_gpio_teardown(struct device *dev)
{
  return ;
}

static struct shlcdc_platform_data shlcdc_pdata = {
	.setup    = msm_shlcdc_gpio_setup,
	.teardown = msm_shlcdc_gpio_teardown,
};
#endif /* #if defined(CONFIG_SHLCDC_SUBDISPLAY) */
...
#if defined(CONFIG_SHLCDC_SUBDISPLAY)
	{
		.modalias	= SH_SUBLCD_DEVNAME,
		.mode		= SPI_MODE_3,
		.bus_num	= 0,
		.chip_select	= 1,
		.max_speed_hz	= 4006957,
		.platform_data	= &shlcdc_pdata,
	},
#endif /* #if defined(CONFIG_SHLCDC_SUBDISPLAY) */
};
#if !defined( CONFIG_TOUCHSCREEN_SHTPS )
...
#if !defined( CONFIG_TOUCHSCREEN_SHTPS ) && !defined( CONFIG_SPI_CUST_SH )
...
#else
#if !defined(CONFIG_SPI_CUST_SH_QSDGPIO) || CONFIG_SPI_CUST_SH_QSDGPIO == 0
...
#endif /* !defined(CONFIG_SPI_CUST_SH_QSDGPIO) || CONFIG_SPI_CUST_SH_QSDGPIO == 0 */
...
#endif /* #if !defined( CONFIG_TOUCHSCREEN_SHTPS )  && !defined( CONFIG_SPI_CUST_SH ) */
};
...
#ifndef CONFIG_SHLCDC_BOARD /* LCD del start */
...
{
#ifdef CONFIG_SHLCDC_BOARD /* LCD del start */
	int rc = 0;
...
static struct kgsl_platform_data kgsl_pdata = {
	...
	.max_grp3d_freq = 364800000,	//245760000
	.min_grp3d_freq = 249600000,	//192 * 1000*1000,
...
#ifndef CONFIG_SHLCDC_BOARD /* LCD del */
...
#ifdef CONFIG_SHLCDC_BOARD /* LCD add */
	.gpio = 24,
#else /* CONFIG_SHLCDC_BOARD */
	.gpio = 30,
#endif /* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* LCD add */
	msm_fb_register_device("shlcdc", 0);
#endif
...
#ifndef CONFIG_BWPM	 /* BT_001 [Sharp]Disable for bwpm implementation */
...
#endif	/* CONFIG_LEDS_KEY_LED */
#ifdef CONFIG_LEDS_KEYBOARD_LED
	&shkeyboardled_device,
#endif	/* CONFIG_LEDS_KEYBOARD_LED */
};

#if defined( CONFIG_I2C_CUST_SH )
static struct msm_gpio msm_i2c_gpios_hw[] = {
#if !defined(CONFIG_I2C_CUST_SH_MSMGPIO) || CONFIG_I2C_CUST_SH_MSMGPIO == 0
	{ GPIO_CFG(70, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "i2c_scl" },
#else
	{ GPIO_CFG(70, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "i2c_scl" },
#endif /* !defined(CONFIG_I2C_CUST_SH_MSMGPIO) || CONFIG_I2C_CUST_SH_MSMGPIO == 0 */
	{ GPIO_CFG(71, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "i2c_sda" },
};

static struct msm_gpio msm_i2c_gpios_io[] = {
	{ GPIO_CFG(70, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "i2c_scl" },
	{ GPIO_CFG(71, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "i2c_sda" },
};
#else
static struct msm_gpio msm_i2c_gpios_hw[] = {
...
static struct msm_gpio qup_i2c_gpios_io[] = {
	{ GPIO_CFG(0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_scl" },
	{ GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_sda" },
};
static struct msm_gpio qup_i2c_gpios_hw[] = {
#if ! defined(CONFIG_I2C_CUST_SH_QUPGPIO) || CONFIG_I2C_CUST_SH_QUPGPIO == 0
	{ GPIO_CFG(0, 2, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_scl" },
	{ GPIO_CFG(1, 2, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_sda" },
#else
	{ GPIO_CFG(0, 2, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "qup_scl" },
	{ GPIO_CFG(1, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "qup_sda" },
#endif /* ! defined(CONFIG_I2C_CUST_SH_QUPGPIO) || CONFIG_I2C_CUST_SH_QUPGPIO == 0 */
};
#else
static struct msm_gpio qup_i2c_gpios_io[] = {
...
#if defined(CONFIG_PERFLOCK) && !defined(CONFIG_SHSYS_CUST_PERFLOCK)
static unsigned msm7x30_perf_acpu_table[] = {
	245760000,
	768000000,
	1024000000,
};

static struct perflock_platform_data msm7x30_perflock_data = {
	.perf_acpu_table = msm7x30_perf_acpu_table,
	.table_size = ARRAY_SIZE(msm7x30_perf_acpu_table),
};
#endif
...
static struct msm_gpio sdc1_cfg_data[] = {
	{GPIO_CFG(38, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), "sdc1_clk"},
...
static struct mmc_platform_data msm7x30_sdc1_data = {
	...
	.sdiowakeup_irq = MSM_GPIO_TO_INT(42),
#endif
#ifdef CONFIG_MMC_MSM_SDC1_DUMMY52_REQUIRED
	.dummy52_required = 1,
#endif
...
#if defined(CONFIG_SHSYS_CUST_PERFLOCK)
	perflock_init(NULL);
#elif defined(CONFIG_PERFLOCK)
	perflock_init(&msm7x30_perflock_data);
#endif
...
#ifdef CONFIG_SENSORS_AMI602
	i2c_register_board_info(4 /* GSB ID */, msm_gsb_board_info,
				ARRAY_SIZE(msm_gsb_board_info));
#elif defined (CONFIG_MPU_SENSORS_MPU3050)
	/* register MPU3050 on bus0 */
	i2c_register_board_info(4, mpu3050_i2c0_boardinfo,
				ARRAY_SIZE(mpu3050_i2c0_boardinfo));
#elif defined (CONFIG_SH_HSCD)
	i2c_register_board_info(4 /* GSB ID */, msm_gsb_board_info,
				ARRAY_SIZE(msm_gsb_board_info));
#else
...
MACHINE_START(MSM8X55_SVLTE_FFA, "QCT MSM8X55 SVLTE FFA")
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(LYNX_DC40, "SHARP LYNX DC40")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(LYNX_DC45, "SHARP LYNX DC45")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(LYNX_DC55, "SHARP LYNX DC55")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(BEC, "SHARP BEC")
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AS32, "SHARP DECKARD AS32")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AF20, "SHARP DECKARD AF20")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AS35, "SHARP DECKARD AS35")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AS50, "SHARP DECKARD AS50")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AS36, "SHARP DECKARD AS36")
    #ifdef CONFIG_MSM_DEBUG_UART
    .phys_io  = MSM_DEBUG_UART_PHYS,
    .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
    #endif
